...
def main():
  ...
  swaps_sum_d = [0 for i in range(51)]
  ...
  comp_sum_d = [0 for i in range(51)]
  ...
  plt.plot([n for n, _ in swaps_d], [swaps_sum_d[n]/k for n, _ in swaps_d], label="DualPivotSort")
  plt.xlabel("n")
  plt.ylabel("swaps")
  ...
  plt.plot([n for n, _ in comparisons_d], [comp_sum_d[n]/k for n, _ in comparisons_d ], label="DualPivotSort")
  plt.xlabel("n")
  ...
  plt.plot([n for n, _ in swaps_d], [swaps_sum_d[n]/(k*n) for n, _ in swaps_d], label="DualPivotSort")
  plt.xlabel("n")
  plt.ylabel("swaps")
  ...
  plt.plot([n for n, _ in comparisons_d], [comp_sum_d[n]/(k*n) for n, _ in comparisons_d ], label="DualPivotSort")
  plt.xlabel("n")
  plt.ylabel("comparisons")
