...
def main():
  ...
  plt.subplot(221)
  plt.plot([n for n, _ in swaps_d], [swaps_sum_d[n]/k for n, _ in swaps_d], label="DualPivot")
  ...
  plt.subplot(222)
  plt.plot([n for n, _ in comparisons_d], [comp_sum_d[n]/k for n, _ in comparisons_d ], label="DualPivot")
  ...
  plt.subplot(223)
  plt.plot([n for n, _ in swaps_d], [swaps_sum_d[n]/(k*n) for n, _ in swaps_d], label="DualPivot")
  ...
  plt.subplot(224)
  plt.plot([n for n, _ in comparisons_d], [comp_sum_d[n]/(k*n) for n, _ in comparisons_d ], label="DualPivot")
