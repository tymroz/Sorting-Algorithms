...
def main():
  ...
  plt.subplot(223)
  plt.plot([n for n, _ in swaps_i], [swaps_n/n for n, swaps_n in swaps_i], label="InsertionSort")
  ...
  plt.subplot(224)
  plt.plot([n for n, _ in comparisons_i], [comparisons_n/n for n, comparisons_n in comparisons_i ], label="InsertionSort")
